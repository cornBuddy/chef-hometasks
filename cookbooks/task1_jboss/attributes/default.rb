...
default['jboss']['deploy_dir'] = "#{default['jboss']['core']['dest']}/standalone/deployments"
default['jboss']['artifact_name'] = 'jsp-servlet-example.war'
default['jboss']['artifact_path'] = "#{default['jboss']['deploy_dir']}/#{default['jboss']['artifact_name']}"
